    ...
    <nav class="nav bg-white example" >
        <div id="menu">
            <div>
                ...
                <div class="nav_list">
                    <a href="/part_time/dashboard" class="nav_link active mb-1 text-dark link-secondary"><i
                            class='bx bx-grid-alt nav_icon'></i> <span class="nav_name">Dashboard</span> </a>
                    <a href="/part_time/employee-list" class="nav_link mb-1 text-dark link-secondary"> <i
                            class='bx bx-user nav_icon'></i> <span class="nav_name">Employees</span> </a>
                
                    <a href="/part_time/offers" class="nav_link mb-1 text-dark link-secondary"
                        ...
                        <a href="/part_time/calendar-view" class="nav_link mb-1 text-dark link-secondary"
                        class=" nav_link nav-link px-0 mx-0 align-middle"> <i class="bi bi-eye nav_icon"></i> <span class="nav_name">View calendar</span> </a>
         

                    <div ><a href="/part_time/my-statistics" class="nav_link  mb-1 text-dark link-secondary"> <i
                                class='bx bx-bar-chart-alt-2 nav_icon'></i> <span class="nav_name">My statistics</span>
                        </a>
                    </div>
                    <div ><a href="/part_time/time-options" class="nav_link  mb-1 text-dark link-secondary"> <i class='bx bx-briefcase-alt nav_icon' ></i> <span class="nav_name">My time options</span>
                        </a>
                    </div>
            ...
            <div class="dropdown pb-4 d-inline d-sm-none " style="overflow-x: visible;" id="ne">
                ...
                <ul id="drop_menu" class="dropdown-menu dropdown-menu-dark text-small shadow text-black dropdown-toggle"
                    ...
                    <li><a class="dropdown-item" href="/part_time/editor-profile"><i class="bi bi-person"></i></a></li>
                    <li>
