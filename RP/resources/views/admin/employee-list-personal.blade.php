                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="card mt-3">
                            ...
                            <div class=" align-items-center flex-wrap p-3">
                                ...
                                <br>
                                <div>
                                    <h6 class="mb-0 " style="display: inline">Status </h6>
                                    <div style="display: inline; float: right">
                                        <input type="radio" id="Active"
                                            style="display: inline;accent-color: green;"
                                            onclick="r_status_check(this.id)" name="r-status" value="1">
                                        <span style="display: inline; margin-right: 20px"
                                            class="rounded text-bg-success  p-1 " for="Active">Active</span>
                                        <input type="radio" id="Suspend"
                                            style="display: inline;accent-color: yellow"
                                            onclick="r_status_check(this.id)" name="r-status" value="0">
                                        <span style="display: inline" class="rounded text-bg-warning p-1 "
                                ...
                                <div class="mt-2" style="display: inline; float: left">
                                    ...
                                    <input type="radio" id="Administrator"
                                        style="display: inline;accent-color: black;" name="r-role"
                                        onclick="r_check(this.id)" value="admin">
                                ...
                                <div class="mt-2" style="display: inline; float: right">
                                    <input type="radio" id="Manager" style="display: inline;accent-color: red"
                                        onclick="r_check(this.id)" name="r-role" value="manager">
                                ...
                                <?php if ($user->role == 'admin') {
                                    ...
                                    echo "<script> document.getElementById('Manager').checked = true; </script>";
                                } elseif ($user->role == 'fulltime') {
